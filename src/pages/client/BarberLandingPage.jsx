...
import { Navigation, Scissors, MessageSquare, X } from 'lucide-react'
...
export default function BarberLandingPage() {
  ...
  // ── LOGGED-IN CLIENT VIEW: SKIP RED SCREEN & GO TO GREEN SCREEN ──
  if (isClient) {
    return <Navigate to={`/b/${barberSlug}/dashboard`} replace />
  }
