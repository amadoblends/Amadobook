...
import { Camera, LogOut, Bell, Settings } from 'lucide-react'
...
.field{width:100%;background:transparent;border:none;border-bottom:1.5px solid ${BORDER};outline:none;color:${TXT};padding:10px 0;font-size:15px;font-weight:500;font-family:'DM Sans',system-ui,sans-serif;transition:border-color 0.2s}
