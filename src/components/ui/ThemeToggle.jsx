          ...
          <div style={{ display:'flex', gap:10 }}>
            {barberAccents.map(a => (
              <button key={a.id} onClick={()=>setAccent(a.color)}
                ...
                <div style={{ width:26, height:26, borderRadius:'50%', background:a.color, border:`3px solid ${accent===a.color?'white':'transparent'}`, boxShadow:accent===a.color?`0 0 0 2px ${a.color}`:'none' }}/>
