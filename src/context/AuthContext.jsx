...
export function AuthProvider({ children }) {
  ...
  useEffect(() => {
    const unsub = onAuthStateChanged(auth, async (u) => {
      if (u) {
        setUser(u)
        // CRITICAL: always load from Firestore to get correct role
        // This prevents the bug where a barber session loads as client
  ...
  return (
    <AuthContext.Provider value={{
      ...
      signUpBarber, signUpClient, signIn, signInWithGoogle,
